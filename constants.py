...
TARGET_ORDER_PLACED = './audio/target_order_placed.mp3'
INSIDE_CANDLE_FOUND = './audio/inside_candle_found.mp3'
INTERNET_NOT_AVAILABLE = './audio/internet_not_available.mp3'
